...
if opt.save_as_heatmap == 1 then
  image.save(opt.out_path .. 'vqa_gcam_hm_' .. opt.caption .. '.png', image.toDisplayTensor(hm))
else
  image.save(opt.out_path .. 'vqa_gcam_' .. opt.caption .. '.png', image.toDisplayTensor(gcam))
end
